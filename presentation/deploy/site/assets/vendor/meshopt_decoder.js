/* meshopt_decoder — vendored UMD (global window.MeshoptDecoder), file:// 友好。
   源自 meshoptimizer 1.0 (MIT, Arseny Kapoulkine)，内嵌 base64 wasm，无额外 fetch。
   仅把 ESM 的 export 改成挂全局，供经典 <script> + r137 GLTFLoader.setMeshoptDecoder 用。 */
