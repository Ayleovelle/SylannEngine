...
- [6. 动力学指标 (dynamics)](#6-动力学指标-dynamics)
- [7. 上下文参数与事件标签](#7-上下文参数与事件标签)
- [8. 完整集成示例](#8-完整集成示例)
- [9. Vibe Coding 速查](#9-vibe-coding-速查)
- [10. 注意事项](#10-注意事项)
